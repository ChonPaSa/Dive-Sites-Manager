...
Description: Create and manage dive sites with some characteristics and a picture. The list can be display on the front-end with a shortcode.
Version: 1.0.0
Author: chonicodefish
Author URI: https://choni.code-fish.eu
License: GPLv3 or later
License URI: https://www.gnu.org/licenses/gpl-3.0.en.html
Text Domain: cfish-dive-sites-manager
*/
